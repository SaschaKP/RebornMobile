...
namespace ClassicUO.Game.UI.Gumps
{
    internal class AssistantHotkeyButtonGump : AnchorableGump
    {
        ...
        public AssistantHotkeyButtonGump(string hotkeyName, string prettyname, int x, int y) : this()
        {
            X = x;
            Y = y;
        ...
        public override void Restore(XmlElement xml)
        {
            ...
            if (string.IsNullOrEmpty(_hotkeyName) == false && string.IsNullOrEmpty(_prettyName) == false)
            {
                BuildGump();
            }
        }

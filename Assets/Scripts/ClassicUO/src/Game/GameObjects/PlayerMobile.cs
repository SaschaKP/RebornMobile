    ...
    internal class PlayerMobile : Mobile
    {
        ...
        public bool Walk(Direction direction, bool run)
        {
            if (Walker.WalkingFailed || Walker.LastStepRequestTime > Time.Ticks || Walker.StepsCount >= Constants.MAX_STEP_COUNT ||
                (Client.Version >= ClientVersion.CV_60142 && IsParalyzed) || Walker.RequestDate > DateTime.UtcNow)
                return false;
            ...
            Walker.RequestDate = DateTime.UtcNow + TimeSpan.FromMilliseconds(walkTime);

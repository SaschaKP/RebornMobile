        ...
        private Gump GetGumpForStep()
        {
            ...
            switch (CurrentLoginStep)
            {
                case LoginSteps.Main:
                    ...
                    return new LoginGump(this) { X = disp };

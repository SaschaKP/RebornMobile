...
namespace ClassicUO.Game.UI.Gumps
{
    class UOChatGumpChooseName : Gump
    {
        ...
        public UOChatGumpChooseName() : base(0, 0)
        {
            ...
            Label text = new Label("You are about to choose your name for the chat system. This name will be PERMANENT and unique on this shard. It will apply to all characters using this account. Do not use your account name for this name as the name you choose will be public. Enter your chat name here:"
                                   , true, 23, Width - 17, 3)
            {
                X = 6,
                Y = 6

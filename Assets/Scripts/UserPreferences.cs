...
public static class UserPreferences
{
    ...
    public static void Initialize()
    {
        ...
        TargetFrameRate = new IntPreference(nameof(TargetFrameRate), (int) TargetFrameRates.Thirty);
        ...
        //UseLegacyJoystick = new IntPreference(nameof(UseLegacyJoystick), (int) PreferenceEnums.UseLegacyJoystick.On);
